...
void Sandbox::OnCreate()
{
	...
	// Create Shaders
	m_shaders = {
		{"core", std::make_shared<Shader>("../../res/shaders/core.vs.glsl", "../../res/shaders/core.fs.glsl")},
		{"cube_light", std::make_shared<Shader>("../../res/shaders/cube_light.vs.glsl", "../../res/shaders/cube_light.fs.glsl")},
	};
